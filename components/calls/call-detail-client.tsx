  ...
  return (
    <div className="space-y-0">
      ...
      <div className="mb-6">
        <Link
          href="/calls"
          className="mb-4 inline-flex items-center gap-1.5 text-[13px] text-gray-400 hover:text-gray-600 transition-colors"
        >
      ...
      {/* Stats strip */}
      <div className="mb-6 grid grid-cols-4 gap-px rounded-md border border-gray-200 bg-gray-200 overflow-hidden">
        {[
          {
            label: "Duration",
            value: formatDuration(displayCall.duration_seconds),
          },
          {
            label: "Lane",
            value: formatLane(
              displayCall.lane_origin,
              displayCall.lane_destination,
            ),
          },
          {
            label: "Equipment",
            value: displayCall.equipment_type,
            isBadge: true,
          },
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 bg-white px-2 py-4 rounded-md border border-gray-200">
